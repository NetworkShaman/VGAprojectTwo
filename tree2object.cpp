#include "tree2object.h"

tree2object::tree2object(ShaderProgram* program, VertexBuffer* buffer, ObjectProperty property)
...
void tree2object::render(QMatrix4x4 transformationMatrix){
    ...
    glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_BYTE, (void*)(6*sizeof(GLubyte)) );
